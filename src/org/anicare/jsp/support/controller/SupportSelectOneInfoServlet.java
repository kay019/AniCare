 ...
 */
@WebServlet("/selectOneInfo.sp")
public class SupportSelectOneInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupportSelectOneInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("잘 조회 해왔는감.. hamp :" + hmap);
		...
		if(hmap != null) {
			...
			path ="views/admin/support/adminSupportOneOnOneDetail.jsp";
		}else {
