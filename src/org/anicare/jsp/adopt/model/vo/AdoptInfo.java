...
public class AdoptInfo {
	...
	public AdoptInfo(int weight, String fixing, int age, String potty, String chip, String personality, String dcode) {
		super();
		this.weight = weight;
		this.fixing = fixing;
		this.age = age;
	...
	public String toString() {
		return "AdoptInfo [weight=" + weight + ", fixing=" + fixing + ", age=" + age + ", potty=" + potty + ", chip="
