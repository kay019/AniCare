...
<body>
	...
	<div id="form_wrapper">
		<form id="writeForm" action="${pageContext.request.contextPath }/insertAdoptionBoard.bo" method="post">
			
			<span style="font-size:25px;">입양후기 글쓰기</span>
			<!-- hr area -->
	...
	<script>
		...
		$("#resetBtn").click(function() {
			...
			if(window.confirm("목록으로 이동하시겠습니까?")) {
				location.href="${pageContext.request.contextPath}/views/board/adoptionBoard.jsp";
			}
		}).mouseenter(function() {
