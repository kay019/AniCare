			...
			<div id="info">
				...
				<div id="iright" class="info">
					...
					<c:choose>
						...
						<li> <c:out value="${sessionScope.loginUser.phone }"/></li>
						<li><c:out value="${sessionScope.loginUser.email}"/></li>
						<li>[자택]</li>
						<li><c:out value="${sessionScope.loginUser.address }"/></li>
						<li>수신 (자택)</li>
						<li>아니오</li>
					</ul>
				</div>
			</div>
			<div class="bt"><button onclick="location.href='myPageChangeInfo2.jsp'">회원 수정 </button></div>
