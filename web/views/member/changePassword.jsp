...
#right > div:nth-child(2) input {
	height: 30px;
	width: 270px;
}
#right > div:nth-child(3) button{
	height:50px;
	width: 100px;
	margin-top: 20px;
}

#right > div:nth-child(2) li:nth-child(n) {
	padding: 10px 20px;
}
...
<body>
	...
	<hr  style = "border: solid 1px blue;">
		...
		<ul>
			...
			<li><a
				href="${ applicationScope.contextPath}/history.me" style ="color:blue">비밀번호 변경</a></li>
		</ul>
		<hr>	
		<ul>
			<li>후원정보</li>
		...
		<div id="right" class="cont">
			<div>기존 비밀번호와 새 비밀번호를 입력해 주십시오. </div>
			<div>		
				<ul>
					<li>*기존 비밀번호</li>
					<li><input type="password"  name="origin" id="pwd" required></li>
				</ul>
				<ul>
					<li>*새 비밀번호</li>
					<li><input type="password"  id="newpwd1" class="pw" name ="newPwd" required></li>
				</ul>
				<ul>
					<li>*새 비밀번호 확인 </li>
					<li><input type="password"  id="newpwd2" class="pw" name="newPwd2" required></li>
				</ul>
	
   					 
			</div>				
			
			<div class="bt"><button id="idCheck">확인</button></div>
		</div>
		</form>
