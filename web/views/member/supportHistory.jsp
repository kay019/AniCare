...
#di2  tr:nth-child(1) >th {
	padding: 10px 40px 15px 40px;
	font-size: 15px;
}
#di2 tr:nth-child(2) >th{
...
<body>
	...
	<hr  style = "border: solid 1px blue;">
		...
		<ul>
			<li>후원정보</li>
			<li><a
				href="${pageContext.request.contextPath }/views/member/supportHistory.jsp"  style ="color:blue">약정내역</a></li>
			<li><a
				...
				<c:when test="${ requestScope.list. }"> --%>
					<c:forEach var="n" items="${ requestScope.list }">
						<table>
							...
							<tr>
								<th><c:out value="${n.sDate }"/></th>
								<th><c:out value="${n.st }"/></th>
								<th><c:out value="${n.money }"/>원</th>
								<th></th>
							</tr>
						</table>
						<hr align="left" width="800px" >
		...
		<%-- 		</c:when>
			...
			<div id="di3">
				...
				약정 해지 방법: 해지하실 후원 항목을 클릭 하신 후 버튼을 눌러 주세요
			</div>
