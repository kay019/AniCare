...
/* 	function check(){
		...
		if(form.ex[0].checked == true){
			...
			form.action="memberJoinForm.jsp";
		}

		else{
			form.action = "memberJoinForm2.jsp";
		}
		form.submit();
	} */
...
<body>
	...
	<div >
		<br><br>
		<center><font size="5">일반 회원가입 양식</font></center>
		<form name="form1" method="post" >
			<div id="input">
				<input type = "radio" name="ex" class="radio" value="1" id="gen" onclick="changeView(0)" checked><label for="gen" >일반화원</label>
		<input type = "radio" name="ex" value="2" class="radio" id="int" onclick="changeView(1)"><label for="int">기업회원</label>
		
		<!-- &nbsp;&nbsp; <a href = "javascript:check()">확인</a> -->
			</div>
		</form>
		<br><br>
			<form id="joinForm" action="${ applicationScope.contextPath }/insertMember.me">
